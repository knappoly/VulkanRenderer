...
//
Mesh* CreateQuad(const Vector3& mins, const Vector3& maxs, const Rgba& color)
{
...
//
Mesh* CreateTexturedQuad(const Vector3& mins, const Vector3& maxs, const Rgba& color, const Vector2& texCoordsAtMins, const Vector2& texCoordsAtMaxs)
{
	MeshBuilder builder;
	...
	builder.End();
	return builder.CreateMesh<VertexLit>();
}
...
//
Mesh* CreateLine(const Vector3& start, const Vector3& end, const Rgba& color)
{
...
// Creates a line using the mesh builder and returns a reference
//
Mesh* CreateLine(const Vector3& start, const Vector3& end, const Rgba& startVertColor /*= Rgba::WHITE*/, const Rgba& endVertColor /*= Rgba::WHITE */)
{
	MeshBuilder builder;
...
//
Mesh* CreateCube(const Vector3& center, const Vector3& size, const Rgba& color, const AABB2& uvTop, const AABB2& uvSide, const AABB2& uvBottom)
{
	MeshBuilder builder;
	builder.Begin(PRIMITIVE_TRIANGLES, true);
...
//
Mesh* CreateUVSphere(const Vector3& position, float radius, uint wedges, uint slices, const Rgba& color)
{
	MeshBuilder builder;
...
Mesh* CreatePoint(const Vector3& position, const Rgba& color /*= Rgba::WHITE */)
{
	...
	return builder.CreateMesh<Vertex_3DPCU>();
