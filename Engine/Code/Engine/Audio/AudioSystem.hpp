...
public:
	...
	virtual float				GetSoundVolume(SoundPlaybackID SoundPlaybackID);
	virtual void				ValidateResult( FMOD_RESULT result );
			SoundPlaybackID		PlayOneOffGroup( const char* name );
	...
	static	void				LoadAudioGroupsFromXML( const char* filePath );
...
protected:
	...
	std::map<std::string, AudioGroup*>	m_registeredAudioGroups;
};
