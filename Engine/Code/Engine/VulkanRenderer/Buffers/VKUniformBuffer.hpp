...
//-----------------------------------------------------------------------------------------------
class VKUniformBuffer : public VKRenderBuffer
{
public:
	//-----------------------------------------------------------------------------------------------
	// Constructors/Destructors
	VKUniformBuffer( VKRenderer* renderer );
	VKUniformBuffer( void* logicalDevice, void* physicalDevice );
	~VKUniformBuffer();
	...
	template<typename T>
	static VKUniformBuffer* For( VKRenderer* renderer, const T& v )
	{
		VKUniformBuffer* buffer = new VKUniformBuffer(renderer);
		buffer->Set<T>(v);
